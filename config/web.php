...
$config = [
    ...
    'components' => [
        ...
        'request' => [
            ...
            'cookieValidationKey' => 'aAMYBKhSzFMFhysBODi-WXwreEXyTY8K',
        ],
        'cache' => [
...
//            'showScriptName' => false,
    ...
    'modules' => [
        ...
        'appttfadmin' => [
            'class' => 'app\modules\ttfadmin\Module',
            'layoutPath' => '@vendor/dmstr/yii2-adminlte-asset/example-views/yiisoft/yii2-app/layouts',
            'layout' => 'main'
        ],
        ],
    'params' => $params,
